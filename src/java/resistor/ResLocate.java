...
public class ResLocate {
    ...
    private static final String PATH = "res/img/srctest/";
    ...
    public List<Mat> resLocate(Mat src) {
      ...
      Imgproc.threshold(src_gray, img_threshold, threshold, 255, Imgproc.THRESH_OTSU); //效果最好，计算量最大
 //       Imgproc.threshold(src_gray, img_threshold, threshold, 255, Imgproc.THRESH_BINARY);
